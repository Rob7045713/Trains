...
import apra.trainsgame.GameAction;
...
public class PCInputManager implements InputManager {
    ...
    private ConcreteMouseListener mouseListener;
	...
	public PCInputManager()
	{
		...
		mouseListener = new ConcreteMouseListener ();
	...
	public ConcreteMouseListener getMouseListener()
	{
	...
	public void doInput(TrainsGame game)
	{
		...
		Iterator<MouseEvent> mouseIterator = mouseListener.getMouseEventsIterator();
		while (mouseIterator.hasNext())
		{
		    System.out.println ("PCInputManager has a mouse event!");
		    MouseEvent event = mouseIterator.next ();
		    game.pointerDown (event.getX (), event.getY ());
		}
	}
}
